module.exports = ->
  ...
  @initConfig
    ...
    combine:
      browser:
        input: 'browser/noflo-interpolator.js'
        output: 'browser/noflo-interpolator.js'
        tokens: [
          token: '.coffee'
          string: '.js'
        ]
    ...
    uglify:
      ...
      noflo:
        files:
          './browser/noflo-interpolator.min.js': ['./browser/noflo-interpolator.js']

    # Automated recompilation and testing when developing
    watch:
      files: ['spec/*.coffee', 'components/*.coffee', 'lib/*.coffee']
      tasks: ['test']
